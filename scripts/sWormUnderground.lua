...
local sndRoarD = "sounds/scary_roar.wav"
...
Spring.PlaySoundFile(sndRoarD,2.0,unitx,unity,unitz)
...
Move(center,y_axis,130, 16)-- the whole thing is wheighting tons of tons, so propelling itself out of the sand, slows it down
for i=1,11 do
...
Move(center,y_axis,42, 11)
WaitForMove(center,y_axis)
Move(center,y_axis,10, 7)
closeMouth()
for i=1,11 do
	randX=math.random(-25,25)
	randZ=math.random(-25,25)
