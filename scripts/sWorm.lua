...
fallDirectionX=math.random(-16,16) --determinates a fall Angle
fallDirectionZ=math.random(-16,16) --determinates a fall Angle
...
Move(center,y_axis,-100, 16)-- the whole thing is wheighting tons of tons, so propelling itself out of the sand, slows it down
for i=1,11 do
...
Move(foodmagnet,y_axis,-unitHeight, 11) -- expecting unit to be attached to foodmagnet from this point towards
Move(center,y_axis,-188, 11)
WaitForMove(center,y_axis)
Move(center,y_axis,-221, 7)
closeMouth()
for i=1,11 do
	randX=math.random(-25,25)
	randZ=math.random(-25,25)
...
--if fallDirectionX < 74 and fallDirectionX > 0 or fallDirectionX > -74 and fallDirectionX < 0 then
--fallDirectionX=fallDirectionX+fallDirectionX
--end
--if fallDirectionZ < 74 and fallDirectionZ > 0 or fallDirectionZ > -74 and fallDirectionZ < 0 then
--fallDirectionZ=fallDirectionZ+fallDirectionZ
--end
--Turn(sWormSeg4,x_axis,math.rad(fallDirectionX),(math.sqrt(fallDirectionX^2)/10))
--Turn(sWormSeg4,z_axis,math.rad(fallDirectionZ),(math.sqrt(fallDirectionZ^2)/10))
