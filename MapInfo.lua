...
local mapinfo = {
	...
	description = "Cattle and Loveplay. Dune. Desert map. By default, non-metal extracting buildings sink into sand as well as wrecks, and movement on rock is 25% faster than on sand. Sand worms will eat your units on the sand. Many thanks to knorke, Google_Frog, SirArtturi, PicassoCT, FabriceFABS, and 8611. Some sound effects from http://www.freesfx.co.uk",
	author      = "eronoobos",
	version     = "7",
	--mutator   = "deployment";
	...
	splats = {
		...
		texScales = {0.009, 0.05, 0.015, 0.007},
